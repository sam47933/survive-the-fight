...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.Player, function (sprite, otherSprite) {
    ...
    mp.setPlayerSprite(mp.playerSelector(mp.PlayerNumber.Two), sprites.create(img`
        ...
        . . . . . f . . . f . . . . . . 
        `, SpriteKind.Player))
    mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.Two)).setPosition(71, 85)
})
controller.left.onEvent(ControllerButtonEvent.Pressed, function () {
    mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.One)).x += -20
})
...
controller.player2.onButtonEvent(ControllerButton.Right, ControllerButtonEvent.Pressed, function () {
    mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.Two)).x += 20
})
...
controller.player1.onButtonEvent(ControllerButton.A, ControllerButtonEvent.Pressed, function () {
    ...
    scaling.scaleByPercent(projectile, -50, ScaleDirection.Vertically, ScaleAnchor.Middle)
    scaling.scaleByPercent(projectile, -50, ScaleDirection.Horizontally, ScaleAnchor.Middle)
    pause(200)
})
...
mp.setPlayerSprite(mp.playerSelector(mp.PlayerNumber.Two), sprites.create(img`
    ...
    . . . . f . . . f . . . . . . . 
    `, SpriteKind.Player))
mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.One)).setPosition(72, 20)
mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.Two)).setPosition(71, 85)
